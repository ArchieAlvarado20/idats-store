...
//addtransactionFunction
 ...
 if(isset($_POST['update_Transaction'])){
    ...
    $query = "UPDATE tblcategory SET category='$name' WHERE id='$transaction_id'";
    $query_run = mysqli_query($con, $query);
 ...
 if(isset($_GET['transaction_id']))
 {
     ...
     $query = "SELECT * FROM tblcategory WHERE id='$transaction_id'";
     $query_run = mysqli_query($con, $query);
 ...
 if(isset($_POST['delete_transaction']))
 {
     ...
     $query = "DELETE FROM tblcategory WHERE id='$transaction_id'";
     $query_run = mysqli_query($con, $query);
     if($query_run)
     {
         $res = [
